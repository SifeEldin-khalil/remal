...
import { Subscription } from 'rxjs/internal/Subscription';
  ...
  export class AppearDirective implements AfterViewInit, OnDestroy {
    ...
    isVisible(){
      ...
      console.log("this.elementPos",this.elementPos);
      console.log("this.elementHeight",this.elementHeight);

      return this.scrollPos+200 >= this.elementPos || (this.scrollPos + this.windowHeight) >= (this.elementPos + this.elementHeight);
    }
